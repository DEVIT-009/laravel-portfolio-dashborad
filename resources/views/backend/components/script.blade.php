...
<script src="{{ asset('backend_assets/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js') }}"></script>
<!-- Moment -->
<script src="{{ asset('backend_assets/plugins/moment/moment.min.js') }}"></script>
<!-- InputMask -->
<script src="{{ asset('backend_assets/plugins/inputmask/jquery.inputmask.min.js') }}"></script>
<!-- Date Range Picker -->
<script src="{{ asset('backend_assets/plugins/daterangepicker/daterangepicker.js') }}"></script>
<!-- Bootstrap Color Picker -->
<script src="{{ asset('backend_assets/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
<!-- Tempusdominus -->
<script src="{{ asset('backend_assets/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
<!-- Bootstrap Switch -->
<script src="{{ asset('backend_assets/plugins/bootstrap-switch/js/bootstrap-switch.min.js') }}"></script>
<!-- BS Stepper -->
<script src="{{ asset('backend_assets/plugins/bs-stepper/js/bs-stepper.min.js') }}"></script>
<!-- Dropzone -->
<script src="{{ asset('backend_assets/plugins/dropzone/min/dropzone.min.js') }}"></script>
