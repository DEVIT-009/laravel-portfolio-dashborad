@php
    ...
    $isManagerial = $position->is_managerial;
                            ...
                            <form action="{{ route('Backend.position.update', $id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description"
                                              ...
                                              placeholder="Position description...">{{ old('description', $description) }}</textarea>
                                    @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="managerial_yes"
                                               value="1"
                                            {{ old('is_managerial', $isManagerial) == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input"
                                               ...
                                               id="managerial_no"
                                               value="0"
                                            {{ old('is_managerial', $isManagerial) == 0 ? 'checked' : '' }}>
